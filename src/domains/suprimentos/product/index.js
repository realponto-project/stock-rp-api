...
module.exports = class SupProductDomain {
  async create(body, options = {}) {
    ...
    const supProductCreated = await SupProduct.create(supProduct, { transaction })

    const response = await supProductCreated.update(
  ...
  async getAll(options = {}) {
    ...
    const where = query.compra
      ? {
        ...getWhere("supProduct"),
        minimumQuantity: { [operators.gt]: { [operators.col]: "supProduct.amount" } },
        esporadico: false
      }
      : getWhere("supProduct")
  ...
  async update(body, options = {}) {
    ...
    const response = await oldSupProduct.update(supProduct, { transaction })
